...
use App\Livewire\AcademicInformations;
use App\Livewire\CareerPreferenceForm;
...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    Route::get('/academic-information', AcademicInformations::class)->name('academic-information');

    // Route for the getting the data feed
    Route::get('/json-data-feed', [DataFeedController::class, 'getDataFeed'])->name('json_data_feed');

    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard');
    Route::get('/dashboard/career-preferences/{studentId}', CareerPreferenceForm::class)->name('career-preferences');
